...
public class Plan implements Serializable {
	...
	public Plan(Long planId, String planName, Integer amount, Integer balance, Integer data, Integer validity) {
		this.planId = planId;
	...
	public String toString() {
		return "Plan [planId=" + planId + ", planName=" + planName + ", amount=" + amount + ", balance=" + balance
